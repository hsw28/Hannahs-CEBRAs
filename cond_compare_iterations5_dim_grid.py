...
def cond_compare_iterations5_dim_grid(traceA1An_An, traceAnB1_An, traceA1An_A1, traceAnB1_B1, CSUSAn, CSUSA1, CSUSB1, iterations, parameter_set, dimensions):
    ...
    for dm in dimensions:
        ...
        results = np.zeros((iterations, 41))  # Each iteration results in 8 outputs
    ...
    filename = f"cond5_lr{learning_rate}_mt{min_temperature}_mi{max_iterations}_d{distance}_mode{temp_mode}_{current_time}_DIM_GRID.csv"
