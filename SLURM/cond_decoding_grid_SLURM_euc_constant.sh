...
python -u /home/hsw967/Programming/Hannahs-CEBRAs/scripts/cond_decoding_AvsB_grid_euc_constant.py ./traceAnB1_An.mat ./traceAnB1_B1.mat ./eyeblinkAn.mat ./eyeblinkB1.mat 2 0 --learning_rate .0045,.0055,.0065,.0075  --min_temperature 3,3.5,4 --max_iterations 77000,85000,95000
