...
python -u /home/hsw967/Programming/Hannahs-CEBRAs/scripts/cond_decoding_AvsB_grid_euc_constant.py ./traceAnB1_An.mat ./traceAnB1_B1.mat ./eyeblinkAn.mat ./eyeblinkB1.mat 2 0 --learning_rate 0.0025,.005,.0075,.0099 --min_temperature 1.5,1.75,2,2.25,2.5 --max_iterations 13000,17000,21000,25000,30000,40000
