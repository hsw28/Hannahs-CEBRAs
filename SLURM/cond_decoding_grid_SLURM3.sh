...
python /home/hsw967/Programming/Hannahs-CEBRAs/scripts/cond_decoding_AvsB_grid3.py ./traceAnB1_An.mat ./traceAnB1_B1.mat ./eyeblinkAn.mat ./eyeblinkB1.mat 2 0 --learning_rate 0.05,0.02,0.0095,.0035,.0002 --min_temperature 0.3,0.66,1,1.33,1.67,2,2.33,2.66,3,3.5 --max_iterations 8000,10000,13000,16000,18000,20000,25000
