...
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --array=0-5%3 ## number of jobs to run "in parallel"
#SBATCH --mem=8GB
...
python /home/hsw967/Programming/Hannahs-CEBRAs/scripts/cond_compare_iterations_script.py ./traceA1An_An.mat ./traceAnB1_An.mat ./traceA1An_A1.mat ./traceAnB1_B1.mat ./eyeblinkAn.mat ./eyeblinkA1.mat ./eyeblinkB1.mat 5 0 --iterations 75 --parameter_set_name set0222b
