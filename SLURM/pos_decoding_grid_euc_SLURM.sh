...
python /home/hsw967/Programming/Hannahs-CEBRAs/scripts/pos_decoding_AvsB_grid2.py ./traceA1An_An.mat ./traceA1An_A1.mat ./posAn.mat ./posA1.mat --learning_rate .00775,.001,.0008875,.000775,0.0006625,.00055 --min_temperature .000000001,.05,0.1,.15,.2,.25 --max_iterations 8000,10000,12000,14000,16000,18000
