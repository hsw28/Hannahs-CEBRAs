...
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --array=0-1%2 ## number of jobs to run "in parallel", 0-9%2 would be 10 jobs 2 in parallel
#SBATCH --mem=10GB
...
python /home/hsw967/Programming/Hannahs-CEBRAs/scripts/cond_compare_iterations_script.py ./traceA1An_An.mat ./traceAnB2_An.mat ./traceA1An_A1.mat ./traceAnB2_B2.mat ./eyeblinkAn.mat ./eyeblinkA1.mat ./eyeblinkB2.mat 5 0 --iterations 25 --parameter_set_name set0307_dayb2
