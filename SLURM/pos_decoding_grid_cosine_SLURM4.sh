...
python /home/hsw967/Programming/Hannahs-CEBRAs/scripts/pos_decoding_AvsB_grid.py ./traceA1An_An.mat ./traceA1An_A1.mat ./posAn.mat ./posA1.mat --learning_rate .00000001,.0000000055 --min_temperature 1.00E-09,.05,.1,.15,.2,.25,.4,1,1.5 --max_iterations 6000,8000,10000,14000,18000,20000,25000,30000,40000
