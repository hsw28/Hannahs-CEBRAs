...
python /home/hsw967/Programming/Hannahs-CEBRAs/scripts/cond_decoding_AvsB_grid.py ./traceAnB1_An.mat ./traceAnB1_B1.mat ./eyeblinkAn.mat ./eyeblinkB1.mat 2 0 --learning_rate 0.01,0.0075,0.0055,0.003,0.001,0.00075 --min_temperature .33,.66,1,1.33,1.67,2,2.33 --max_iterations 8000,13000,16000,20000,2500025000
