...
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --array=0-3%2 ## number of jobs to run "in parallel", 0-9%2 would be 10 jobs 2 in parallel
#SBATCH --mem=10GB
...
python /home/hsw967/Programming/Hannahs-CEBRAs/scripts/cond_compare_iterations_script.py ./traceA1An_An.mat ./traceAnB1_An.mat ./traceA1An_A1.mat ./traceAnB1_B1.mat ./eyeblinkAn.mat ./eyeblinkA1.mat ./eyeblinkB1.mat 2 0 --iterations 125 --parameter_set_name set0307
