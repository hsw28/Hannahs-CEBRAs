...
#python /home/hsw967/Programming/Hannahs-CEBRAs/scripts/cond_geometry_preservation_script.py --traceAn_full ./traceAn.mat --traceB1_full ./traceB1.mat --labelsAn ./eyeblinkAn.mat --labelsB1 ./eyeblinkB1.mat --task_bins 5 --pretrial 0 --iterations 20 --shuffles 0 --save_branch A --parameter_set_name set0222 --rat_id rat0222
