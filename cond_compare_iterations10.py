...
from CSUS_score10 import CSUS_score10
import gc
...
def train_and_evaluate(cebra_model, trace_train, trace_test, test_trace, pos_train, pos_test, test_pos):
    ...
    return CSUS_score10(train_transformed, test_transformed, pos_train, pos_test), CSUS_score10(train_transformed, test_external_transformed, pos_train, test_pos)
...
def cond_compare_iterations10(traceA1An_An, traceAnB1_An, traceA1An_A1, traceAnB1_B1, CSUSAn, CSUSA1, CSUSB1, dimensions, iterations, parameter_set):
    ...
    try:
        ...
        filename = f"cond10_lr{learning_rate}_mt{min_temperature}_mi{max_iterations}_d{distance}_mode{temp_mode}_{current_time}.csv"
