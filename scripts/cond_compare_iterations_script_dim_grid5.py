...
from cond_compare_iterations5_dim_grid import cond_compare_iterations5_dim_grid
...
if how_many_divisions == 5:
    cond_compare_iterations5_dim_grid(traceA1An_An, traceAnB1_An, traceA1An_A1, traceAnB1_B1, CSUSAn, CSUSA1, CSUSB1, args.iterations, parameter_set, args.dimensions)
