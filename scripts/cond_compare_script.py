...
import numpy as np
from cond_compare import cond_compare
...
cond_compare(traceA1An_An, traceAnB1_An, traceA1An_A1, traceAnB1_B1, CSUSAn, CSUSA1, CSUSB1, dimensions, learning_rate=args.learning_rate, min_temperature=args.min_temperature, max_iterations=args.max_iterations, distance=args.distance)
