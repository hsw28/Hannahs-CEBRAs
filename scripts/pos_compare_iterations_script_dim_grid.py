...
import numpy as np
from pos_compare_iterations_dim_grid import pos_compare_iterations_dim_grid
from smoothpos import smoothpos
from ca_velocity import ca_velocity

#for using with slurm to run over a bunch of iterations
# python pos_compare_iterations_script_dim_grid.py traceA1An_An traceAnB1_An traceA1An_A1 traceAnB1_B1 PosAn PosA1 PosB1 --iterations 10 --parameter_set_name set0307 --dimensions 1,2,4
# python /Users/Hannah/Programming/Hannahs-CEBRAs/scripts/pos_compare_iterations_script_dim_grid.py ./traceA1An_An.mat ./traceAnB1_An.mat ./traceA1An_A1.mat ./traceAnB1_B1.mat ./PosAn.mat ./PosA1.mat ./PosB1.mat --iterations 3 --parameter_set_name test --dimensions 1,2,4

def parse_list_argument(arg_value):
    dimensions = [int(dim) for dim in arg_value.split(',')]
    return dimensions

# Define parameter sets
parameter_sets = {
    "set0222": {"learning_rate": 0.000055, "min_temperature": 0.000000001, "max_iterations": 25000, "distance": "cosine", "temp_mode": "auto"},
    "set0307": {"learning_rate": 0.000622, "min_temperature": 1.33, "max_iterations": 21000, "distance": "cosine", "temp_mode": "auto"},
    "set0313": {"learning_rate": 0.00055, "min_temperature": 0.95, "max_iterations": 26500, "distance": "cosine", "temp_mode": "auto"},
    "set0314": {"learning_rate": 0.001, "min_temperature": 0.000000001, "max_iterations": 30000, "distance": "cosine", "temp_mode": "auto"},
    "set0816": {"learning_rate": 0.001, "min_temperature": 0.15, "max_iterations": 18000, "distance": "cosine", "temp_mode": "auto"},
    "test": {"learning_rate": 0.001, "min_temperature": 0.15, "max_iterations": 20},
}
...
parser.add_argument("--dimensions", type=parse_list_argument, default=[3], help="Comma-separated max iterations.")
...
pos_compare_iterations_dim_grid(traceA1An_An, traceAnB1_An, traceA1An_A1, traceAnB1_B1, PosAn, PosA1, PosB1, args.iterations, parameter_set, args.dimensions)
