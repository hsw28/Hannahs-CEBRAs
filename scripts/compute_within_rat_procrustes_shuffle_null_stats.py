...
def main():
    ...
    stats_path = os.path.join(args.output_dir, f"within_rat_procrustes_shuffle_null_stats_{timestamp}.csv")
    plot_data_path = os.path.join(args.output_dir, f"within_rat_procrustes_shuffle_null_plot_data_{timestamp}.csv")
