...
import cond_consistencyAB_saved4_dims23
import warnings
...
parameter_set = parameter_sets[args.parameter_set_name]
cond_consistencyAB_saved4_dims23.main(traceA1, traceAn, traceB1, traceB2, trainingA1, trainingAn, trainingB1, trainingB2, args.iterations, parameter_set, args.parameter_set_name)
