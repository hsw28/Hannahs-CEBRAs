...
def main():
    ...
    observations = build_pair_run_observations(args.rat_npz, zscore_before_align=not args.no_zscore)
    ...
    run_scores_path = os.path.join(args.output_dir, "cross_rat_procrustes_run_scores.csv")
    pair_means_path = os.path.join(args.output_dir, "cross_rat_procrustes_actual_rat_pair_means.csv")
    null_means_path = os.path.join(args.output_dir, "cross_rat_procrustes_shuffle_null_means.csv")
    stats_path = os.path.join(args.output_dir, "cross_rat_procrustes_shuffle_null_stats.csv")
    plot_data_path = os.path.join(args.output_dir, "cross_rat_procrustes_shuffle_null_plot_data.csv")
