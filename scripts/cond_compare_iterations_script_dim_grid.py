...
from cond_compare_iterations_dim_grid import cond_compare_iterations_dim_grid


#for using with slurm to run over a bunch of iterations
# python cond_compare_iterations_script_dim_grid.py traceA1An_An traceAnB1_An traceA1An_A1 traceAnB1_B1 CSUSAn CSUSA1 CSUSB1 2 0 --iterations 10 --parameter_set_name set0307 --dimensions 1,2,4
# python /Users/Hannah/Programming/Hannahs-CEBRAs/scripts/cond_compare_iterations_script_dim_grid.py ./traceA1An_An.mat ./traceAnB1_An.mat ./traceA1An_A1.mat ./traceAnB1_B1.mat ./eyeblinkAn.mat ./eyeblinkA1.mat ./eyeblinkB1.mat 2 0 --iterations 3 --parameter_set_name test --dimensions 1,2,4
...
if how_many_divisions == 2:
    cond_compare_iterations_dim_grid(traceA1An_An, traceAnB1_An, traceA1An_A1, traceAnB1_B1, CSUSAn, CSUSA1, CSUSB1, args.iterations, parameter_set, args.dimensions)
#elif how_many_divisions == 5:
#    cond_compare_iterations5_dim_grid(traceA1An_An, traceAnB1_An, traceA1An_A1, traceAnB1_B1, CSUSAn, CSUSA1, CSUSB1, dimensions, args.iterations, parameter_set)
