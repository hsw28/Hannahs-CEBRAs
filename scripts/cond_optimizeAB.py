...
#how to run:
    ...
    #python /Users/Hannah/Programming/Hannahs-CEBRAs/scripts/cond_optimizeAB.py ./traceAn.mat ./traceB1.mat ./eyeblinkAn.mat ./eyeblinkB1.mat 2 0 --learning_rate .001,.004 --min_temperature 0.1,0.3 --max_iterations 5
...
#Example
    # python cond_optimizeAB.py ./traceAnB1_An.mat ./traceAnB1_B1.mat ./eyeblinkAn.mat ./eyeblinkB1.mat 2 0 --learning_rate 1e-4,5e-4 --min_temperature 0.1,0.3 --max_iterations 5000,10000
...
def cond_decoding_AvsB_grid_cebra(envA_cell_train, envB_cell_train, envA_eyeblink, envB_eyeblink, learning_rates, min_temperatures, max_iterations_list, dimensions):
    ...
    for lr, temp, max_iter in product(learning_rates, min_temperatures, max_iterations_list):
        ...
        for i in range(2):
              ...
              eyeblink_train_control, eyeblink_test_control = hold_out(envB_eyeblink, .75)
              cell_train_control, cell_test_control  = hold_out(envB_cell_train,.75)
        ...
        #    'fract_test': fract_test_all,
            'mean_loss': mean_loss,
            'std_loss': std_loss,
            'mean_A': mean_control,  # Correctly calculated mean
            'mean_B': mean_test         # Correctly calculated mean
        })
