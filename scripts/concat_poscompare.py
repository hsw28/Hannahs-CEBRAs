...
# List of CSV files
csv_files = [
    'cond_lr0.0035_mt2.33_mi32000_deuclidean_modeconstant_2024-07-08_02-38-51.csv',
    'cond_lr0.0035_mt2.33_mi32000_deuclidean_modeconstant_2024-07-08_06-20-06.csv'
        #ex
